...
parser.add_argument('-r', '--reihenfolge', dest="reihenfolge")
parser.add_argument('-s', '--seite', dest="seite")
args= parser.parse_args()
list = args.zeile1.split(',')
...
print("Sortiere: ",a,"\n")
TD_Heapsort(a, args.reihenfolge, args.seite)
print(args.reihenfolge, " sortiert, Tiebreak nach ", args.seite ,": ",a,"\n\n")
